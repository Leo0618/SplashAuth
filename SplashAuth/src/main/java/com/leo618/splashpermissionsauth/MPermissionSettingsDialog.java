...
class MPermissionSettingsDialog implements Parcelable, DialogInterface.OnClickListener {
    ...
    public static class Builder {
        ...
        public MPermissionSettingsDialog build() {
            mRationale = TextUtils.isEmpty(mRationale) ? "请打开进入设置修改当前应用权限，以保证正常使用" : mRationale;
            mTitle = TextUtils.isEmpty(mTitle) ? "权限被拒绝" : mTitle;
